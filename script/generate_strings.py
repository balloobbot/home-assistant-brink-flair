        ...
        "step": {
            ...
            "serial_server": {
                ...
                "description": (
                    ...
                    "even parity, 1 stop bit out of the factory. Parity and stop "
                    "bits are the box's business; the baud rate is asked for "
                    "because it spaces the frames."
                ),
                "data": {
                    "host": "Host",
                    "port": "Port",
                ...
                "data_description": {
                    ...
                    "baudrate": (
                        "The speed the box runs its RS-485 line at, step 14.3 on "
                        "the appliance's display. It spaces the Modbus frames."
                    ),
                    "unit_id": (
                        "The appliance's slave address, step 14.2 on its display."
                    ),
